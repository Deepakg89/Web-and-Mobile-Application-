...
class Login extends React.Component {
    ...
    handleSubmitLogin = async () => {
        ...
        const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/users/login', {
            method: 'POST',
            headers: {
        ...
        if (content.token) {
            ...
            await AsyncStorage.setItem("firstname", content.firstname)
            await AsyncStorage.setItem("lastname", content.lastname)
