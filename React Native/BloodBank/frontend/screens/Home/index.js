...
export default class Home extends React.Component {
  ...
  async registerForPushNotificationsAsync(token) {
    ...
    return await fetch('https://blood-bank-6727.herokuapp.com/users/addPushToken', {
      method: 'POST',
      headers: {
  ...
  async componentDidMount() {
    ...
    if (token != null) {
      ...
      const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/getAll', {
        method: 'GET',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  async handleVolunteer(item) {
    ...
    const token = await AsyncStorage.getItem('token');
    if (token !== null) {
      const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/addVolunteer', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
