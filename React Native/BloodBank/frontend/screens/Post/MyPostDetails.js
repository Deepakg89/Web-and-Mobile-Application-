...
export default class MyPostDetails extends React.Component {
  ...
  async componentDidMount() {
    ...
    if (token != null) {
      ...
      const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/getVolunteers', {
        method: 'POST',
        headers: {
      ...
      const comResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/getComment', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  handleComment = async() => {
    ...
    if (comment === '') {
      ...
      const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/addComment', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
  ...
  async handleChange(id){
    ...
    const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/updateStatus', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  handleCheck = async()=>{
    ...
    const docId = this.state.content._id;
      const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/fulfilled', {
        method: 'POST',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
