...
async componentWillMount(){
    ...
    handleOnPress=async()=>{
        ...
        const rawResponse = await fetch('https://blood-bank-6727.herokuapp.com/posts/addPost', {
            method: 'POST',
            headers: {
          ...
          if(content.message === "post added successfully"){
            const toks = await fetch('https://blood-bank-6727.herokuapp.com/users/getPushToken', {
                method: 'GET',
                headers: {
                  'Accept': 'application/json',
                  'Content-Type': 'application/json',
